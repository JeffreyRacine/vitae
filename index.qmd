...
# Disable Quarto's global citeproc; HTML uses citeproc + multibib (PDF build removed; use headless Chrome to print HTML to PDF)
citeproc: false
# Add multibib filter
filters:
  - multibib
  ...
  pdf:
    ...
    include-in-header:
      - text: |
          ...
          % Adjust CSL bibliography label spacing for PDF: move number left slightly and add a small overall inset
          %\setlength{\cslhangindent}{1.8em} % increased hanging indent so wrapped lines align with markdown lists
          %\setlength{\csllabelwidth}{2.4em} % keep label box width
          %\makeatletter
            ...
            document.addEventListener('DOMContentLoaded', function(){
              ...
              if(pkgDiv){
                pkgDiv.querySelectorAll('.csl-entry a').forEach(function(a){
                  ...
                  // Only add a link icon for DOI links. For CRAN package DOIs (doi.org/...CRAN.package...),
                  // also append the R logo AFTER the link icon. Avoid inserting duplicates.
                  // Only add a link icon for non-CRAN DOI links; for CRAN package DOIs, append only the R logo
