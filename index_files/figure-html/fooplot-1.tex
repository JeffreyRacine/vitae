% Created by tikzDevice version 0.12.6 on 2025-12-14 00:00:16
...
\path[fill=fillColor] (221.90, 38.24) rectangle (229.45,180.68);

\path[fill=fillColor] (230.29, 38.24) rectangle (237.84,171.09);
...
\path[draw=drawColor,line width= 0.3pt,line join=round] (297.85, 64.49) --
	(500.39, 64.49);

\path[draw=drawColor,line width= 0.3pt,line join=round] (297.85,116.98) --
	(500.39,116.98);

\path[draw=drawColor,line width= 0.3pt,line join=round] (297.85,169.47) --
	(500.39,169.47);
...
\path[draw=drawColor,line width= 0.6pt,line join=round] (297.85, 90.73) --
	(500.39, 90.73);

\path[draw=drawColor,line width= 0.6pt,line join=round] (297.85,143.22) --
	(500.39,143.22);

\path[draw=drawColor,line width= 0.6pt,line join=round] (297.85,195.72) --
	(500.39,195.72);
...
\path[fill=fillColor] (307.06, 38.24) rectangle (314.30, 41.63);

\path[fill=fillColor] (315.10, 38.24) rectangle (322.34, 42.44);

\path[fill=fillColor] (323.14, 38.24) rectangle (330.38, 43.54);

\path[fill=fillColor] (331.18, 38.24) rectangle (338.42, 45.06);

\path[fill=fillColor] (339.22, 38.24) rectangle (346.46, 47.13);
...
\path[fill=fillColor] (403.54, 38.24) rectangle (410.78, 99.79);

\path[fill=fillColor] (411.58, 38.24) rectangle (418.82,108.34);

\path[fill=fillColor] (419.62, 38.24) rectangle (426.86,118.09);

\path[fill=fillColor] (427.67, 38.24) rectangle (434.90,127.38);

\path[fill=fillColor] (435.71, 38.24) rectangle (442.94,136.44);

\path[fill=fillColor] (443.75, 38.24) rectangle (450.98,145.36);

\path[fill=fillColor] (451.79, 38.24) rectangle (459.02,154.35);

\path[fill=fillColor] (459.83, 38.24) rectangle (467.06,163.13);

\path[fill=fillColor] (467.87, 38.24) rectangle (475.10,171.53);

\path[fill=fillColor] (475.91, 38.24) rectangle (483.14,180.73);
...
\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (292.90, 87.70) {5000};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (292.90,140.19) {10000};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (292.90,192.69) {15000};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,202.36);
\definecolor{drawColor}{gray}{0.20}
...
\path[draw=drawColor,line width= 0.6pt,line join=round] (295.10, 90.73) --
	(297.85, 90.73);

\path[draw=drawColor,line width= 0.6pt,line join=round] (295.10,143.22) --
	(297.85,143.22);

\path[draw=drawColor,line width= 0.6pt,line join=round] (295.10,195.72) --
	(297.85,195.72);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,202.36);
