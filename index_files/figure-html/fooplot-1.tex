% Created by tikzDevice version 0.12.6 on 2025-12-21 00:00:14
...
\path[fill=fillColor] (104.44, 38.24) rectangle (112.00,105.88);

\path[fill=fillColor] (112.83, 38.24) rectangle (120.38,143.77);

\path[fill=fillColor] (121.22, 38.24) rectangle (128.77,140.85);

\path[fill=fillColor] (129.61, 38.24) rectangle (137.16,168.00);

\path[fill=fillColor] (138.00, 38.24) rectangle (145.55,171.09);
...
\path[fill=fillColor] (179.95, 38.24) rectangle (187.50,178.57);

\path[fill=fillColor] (188.34, 38.24) rectangle (195.89,176.29);

\path[fill=fillColor] (196.73, 38.24) rectangle (204.28,177.59);

\path[fill=fillColor] (205.12, 38.24) rectangle (212.67,174.18);

\path[fill=fillColor] (213.51, 38.24) rectangle (221.06,168.33);

\path[fill=fillColor] (221.90, 38.24) rectangle (229.45,181.17);

\path[fill=fillColor] (230.29, 38.24) rectangle (237.84,171.90);
...
\path[draw=drawColor,line width= 0.3pt,line join=round] (297.85, 64.47) --
	(500.39, 64.47);

\path[draw=drawColor,line width= 0.3pt,line join=round] (297.85,116.92) --
	(500.39,116.92);

\path[draw=drawColor,line width= 0.3pt,line join=round] (297.85,169.38) --
	(500.39,169.38);
...
\path[draw=drawColor,line width= 0.6pt,line join=round] (297.85, 90.70) --
	(500.39, 90.70);

\path[draw=drawColor,line width= 0.6pt,line join=round] (297.85,143.15) --
	(500.39,143.15);

\path[draw=drawColor,line width= 0.6pt,line join=round] (297.85,195.61) --
	(500.39,195.61);
...
\path[fill=fillColor] (307.06, 38.24) rectangle (314.30, 41.64);

\path[fill=fillColor] (315.10, 38.24) rectangle (322.34, 42.45);

\path[fill=fillColor] (323.14, 38.24) rectangle (330.38, 43.55);

\path[fill=fillColor] (331.18, 38.24) rectangle (338.42, 45.07);

\path[fill=fillColor] (339.22, 38.24) rectangle (346.46, 47.14);

\path[fill=fillColor] (347.26, 38.24) rectangle (354.50, 50.89);

\path[fill=fillColor] (355.30, 38.24) rectangle (362.54, 55.60);

\path[fill=fillColor] (363.34, 38.24) rectangle (370.58, 59.97);

\path[fill=fillColor] (371.38, 38.24) rectangle (378.62, 66.78);

\path[fill=fillColor] (379.42, 38.24) rectangle (386.66, 73.40);

\path[fill=fillColor] (387.46, 38.24) rectangle (394.70, 81.77);

\path[fill=fillColor] (395.50, 38.24) rectangle (402.74, 90.34);

\path[fill=fillColor] (403.54, 38.24) rectangle (410.78, 99.77);

\path[fill=fillColor] (411.58, 38.24) rectangle (418.82,108.31);

\path[fill=fillColor] (419.62, 38.24) rectangle (426.86,118.06);

\path[fill=fillColor] (427.67, 38.24) rectangle (434.90,127.34);

\path[fill=fillColor] (435.71, 38.24) rectangle (442.94,136.40);

\path[fill=fillColor] (443.75, 38.24) rectangle (450.98,145.30);

\path[fill=fillColor] (451.79, 38.24) rectangle (459.02,154.29);

\path[fill=fillColor] (459.83, 38.24) rectangle (467.06,163.06);

\path[fill=fillColor] (467.87, 38.24) rectangle (475.10,171.46);

\path[fill=fillColor] (475.91, 38.24) rectangle (483.14,180.68);
...
\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (292.90, 87.66) {5000};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (292.90,140.12) {10000};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (292.90,192.58) {15000};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,202.36);
\definecolor{drawColor}{gray}{0.20}
...
\path[draw=drawColor,line width= 0.6pt,line join=round] (295.10, 90.70) --
	(297.85, 90.70);

\path[draw=drawColor,line width= 0.6pt,line join=round] (295.10,143.15) --
	(297.85,143.15);

\path[draw=drawColor,line width= 0.6pt,line join=round] (295.10,195.61) --
	(297.85,195.61);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,202.36);
