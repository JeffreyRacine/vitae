% Created by tikzDevice version 0.12.6 on 2025-12-28 00:00:15
...
\path[fill=fillColor] (171.56, 38.24) rectangle (179.11,182.31);
...
\path[fill=fillColor] (221.90, 38.24) rectangle (229.45,180.20);

\path[fill=fillColor] (230.29, 38.24) rectangle (237.84,174.67);
...
\path[draw=drawColor,line width= 0.3pt,line join=round] (297.85,116.81) --
	(500.39,116.81);

\path[draw=drawColor,line width= 0.3pt,line join=round] (297.85,169.19) --
	(500.39,169.19);
...
\path[draw=drawColor,line width= 0.6pt,line join=round] (297.85, 90.62) --
	(500.39, 90.62);

\path[draw=drawColor,line width= 0.6pt,line join=round] (297.85,143.00) --
	(500.39,143.00);

\path[draw=drawColor,line width= 0.6pt,line join=round] (297.85,195.38) --
	(500.39,195.38);
...
\path[fill=fillColor] (307.06, 38.24) rectangle (314.30, 41.72);

\path[fill=fillColor] (315.10, 38.24) rectangle (322.34, 42.52);

\path[fill=fillColor] (323.14, 38.24) rectangle (330.38, 43.62);

\path[fill=fillColor] (331.18, 38.24) rectangle (338.42, 45.14);

\path[fill=fillColor] (339.22, 38.24) rectangle (346.46, 47.21);

\path[fill=fillColor] (347.26, 38.24) rectangle (354.50, 50.96);

\path[fill=fillColor] (355.30, 38.24) rectangle (362.54, 55.66);

\path[fill=fillColor] (363.34, 38.24) rectangle (370.58, 60.01);

\path[fill=fillColor] (371.38, 38.24) rectangle (378.62, 66.82);

\path[fill=fillColor] (379.42, 38.24) rectangle (386.66, 73.43);

\path[fill=fillColor] (387.46, 38.24) rectangle (394.70, 81.79);

\path[fill=fillColor] (395.50, 38.24) rectangle (402.74, 90.35);

\path[fill=fillColor] (403.54, 38.24) rectangle (410.78, 99.76);

\path[fill=fillColor] (411.58, 38.24) rectangle (418.82,108.29);

\path[fill=fillColor] (419.62, 38.24) rectangle (426.86,118.02);

\path[fill=fillColor] (427.67, 38.24) rectangle (434.90,127.31);

\path[fill=fillColor] (435.71, 38.24) rectangle (442.94,136.35);

\path[fill=fillColor] (443.75, 38.24) rectangle (450.98,145.24);

\path[fill=fillColor] (451.79, 38.24) rectangle (459.02,154.22);

\path[fill=fillColor] (459.83, 38.24) rectangle (467.06,162.98);

\path[fill=fillColor] (467.87, 38.24) rectangle (475.10,171.37);
...
\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (292.90, 87.59) {5000};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (292.90,139.97) {10000};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (292.90,192.35) {15000};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,202.36);
\definecolor{drawColor}{gray}{0.20}
...
\path[draw=drawColor,line width= 0.6pt,line join=round] (295.10, 90.62) --
	(297.85, 90.62);

\path[draw=drawColor,line width= 0.6pt,line join=round] (295.10,143.00) --
	(297.85,143.00);

\path[draw=drawColor,line width= 0.6pt,line join=round] (295.10,195.38) --
	(297.85,195.38);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,202.36);
