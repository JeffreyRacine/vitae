% Created by tikzDevice version 0.12.6 on 2025-12-04 11:53:18
...
\path[fill=fillColor] (188.34, 38.24) rectangle (195.89,175.81);
...
\path[fill=fillColor] (221.90, 38.24) rectangle (229.45,180.85);

\path[fill=fillColor] (230.29, 38.24) rectangle (237.84,168.00);
...
\path[draw=drawColor,line width= 0.3pt,line join=round] (297.85,117.09) --
	(500.39,117.09);

\path[draw=drawColor,line width= 0.3pt,line join=round] (297.85,169.66) --
	(500.39,169.66);
...
\path[draw=drawColor,line width= 0.6pt,line join=round] (297.85, 90.81) --
	(500.39, 90.81);

\path[draw=drawColor,line width= 0.6pt,line join=round] (297.85,143.38) --
	(500.39,143.38);

\path[draw=drawColor,line width= 0.6pt,line join=round] (297.85,195.95) --
	(500.39,195.95);
...
\path[fill=fillColor] (323.14, 38.24) rectangle (330.38, 43.53);

\path[fill=fillColor] (331.18, 38.24) rectangle (338.42, 45.04);

\path[fill=fillColor] (339.22, 38.24) rectangle (346.46, 47.11);
...
\path[fill=fillColor] (387.46, 38.24) rectangle (394.70, 81.82);

\path[fill=fillColor] (395.50, 38.24) rectangle (402.74, 90.40);

\path[fill=fillColor] (403.54, 38.24) rectangle (410.78, 99.85);

\path[fill=fillColor] (411.58, 38.24) rectangle (418.82,108.40);

\path[fill=fillColor] (419.62, 38.24) rectangle (426.86,118.17);

\path[fill=fillColor] (427.67, 38.24) rectangle (434.90,127.47);

\path[fill=fillColor] (435.71, 38.24) rectangle (442.94,136.59);

\path[fill=fillColor] (443.75, 38.24) rectangle (450.98,145.48);

\path[fill=fillColor] (451.79, 38.24) rectangle (459.02,154.48);

\path[fill=fillColor] (459.83, 38.24) rectangle (467.06,163.27);

\path[fill=fillColor] (467.87, 38.24) rectangle (475.10,171.69);

\path[fill=fillColor] (475.91, 38.24) rectangle (483.14,180.91);
...
\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (292.90, 87.78) {5000};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (292.90,140.35) {10000};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (292.90,192.92) {15000};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,202.36);
\definecolor{drawColor}{gray}{0.20}
...
\path[draw=drawColor,line width= 0.6pt,line join=round] (295.10, 90.81) --
	(297.85, 90.81);

\path[draw=drawColor,line width= 0.6pt,line join=round] (295.10,143.38) --
	(297.85,143.38);

\path[draw=drawColor,line width= 0.6pt,line join=round] (295.10,195.95) --
	(297.85,195.95);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,202.36);
