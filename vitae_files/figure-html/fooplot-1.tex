% Created by tikzDevice version 0.12.6 on 2025-03-28 16:04:50
...
\path[fill=fillColor] ( 70.89, 38.24) rectangle ( 78.44, 60.75);
...
\path[fill=fillColor] (104.44, 38.24) rectangle (112.00,109.53);
...
\path[fill=fillColor] (146.39, 38.24) rectangle (153.94,184.90);

\path[fill=fillColor] (154.78, 38.24) rectangle (162.33,171.03);

\path[fill=fillColor] (163.17, 38.24) rectangle (170.72,189.30);

\path[fill=fillColor] (171.56, 38.24) rectangle (179.11,181.64);

\path[fill=fillColor] (179.95, 38.24) rectangle (187.50,178.05);

\path[fill=fillColor] (188.34, 38.24) rectangle (195.89,177.07);
...
\path[fill=fillColor] (221.90, 38.24) rectangle (229.45,186.69);

\path[fill=fillColor] (230.29, 38.24) rectangle (237.84, 74.62);
...
\path[draw=drawColor,line width= 0.3pt,line join=round] (297.85, 65.60) --
	(500.39, 65.60);

\path[draw=drawColor,line width= 0.3pt,line join=round] (297.85,120.33) --
	(500.39,120.33);

\path[draw=drawColor,line width= 0.3pt,line join=round] (297.85,175.06) --
	(500.39,175.06);
...
\path[draw=drawColor,line width= 0.6pt,line join=round] (297.85, 92.97) --
	(500.39, 92.97);

\path[draw=drawColor,line width= 0.6pt,line join=round] (297.85,147.70) --
	(500.39,147.70);
...
\path[fill=fillColor] (307.06, 38.24) rectangle (314.30, 41.51);

\path[fill=fillColor] (315.10, 38.24) rectangle (322.34, 42.38);

\path[fill=fillColor] (323.14, 38.24) rectangle (330.38, 43.58);

\path[fill=fillColor] (331.18, 38.24) rectangle (338.42, 45.09);

\path[fill=fillColor] (339.22, 38.24) rectangle (346.46, 47.18);

\path[fill=fillColor] (347.26, 38.24) rectangle (354.50, 51.03);

\path[fill=fillColor] (355.30, 38.24) rectangle (362.54, 55.83);

\path[fill=fillColor] (363.34, 38.24) rectangle (370.58, 60.61);

\path[fill=fillColor] (371.38, 38.24) rectangle (378.62, 67.73);

\path[fill=fillColor] (379.42, 38.24) rectangle (386.66, 74.47);

\path[fill=fillColor] (387.46, 38.24) rectangle (394.70, 83.22);

\path[fill=fillColor] (395.50, 38.24) rectangle (402.74, 92.25);

\path[fill=fillColor] (403.54, 38.24) rectangle (410.78,102.09);

\path[fill=fillColor] (411.58, 38.24) rectangle (418.82,111.00);

\path[fill=fillColor] (419.62, 38.24) rectangle (426.86,121.13);

\path[fill=fillColor] (427.67, 38.24) rectangle (434.90,130.75);

\path[fill=fillColor] (435.71, 38.24) rectangle (442.94,140.13);

\path[fill=fillColor] (443.75, 38.24) rectangle (450.98,149.45);

\path[fill=fillColor] (451.79, 38.24) rectangle (459.02,158.95);

\path[fill=fillColor] (459.83, 38.24) rectangle (467.06,168.09);

\path[fill=fillColor] (467.87, 38.24) rectangle (475.10,176.90);

\path[fill=fillColor] (475.91, 38.24) rectangle (483.14,186.86);
...
\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (292.90, 89.94) {5000};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (292.90,144.67) {10000};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,202.36);
\definecolor{drawColor}{gray}{0.20}
...
\path[draw=drawColor,line width= 0.6pt,line join=round] (295.10, 92.97) --
	(297.85, 92.97);

\path[draw=drawColor,line width= 0.6pt,line join=round] (295.10,147.70) --
	(297.85,147.70);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,202.36);
