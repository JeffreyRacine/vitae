% Created by tikzDevice version 0.12.6 on 2025-12-05 16:24:23
...
\path[fill=fillColor] ( 70.89, 38.24) rectangle ( 78.44, 61.65);
...
\path[fill=fillColor] (129.61, 38.24) rectangle (137.16,168.16);

\path[fill=fillColor] (138.00, 38.24) rectangle (145.55,170.93);

\path[fill=fillColor] (146.39, 38.24) rectangle (153.94,184.42);

\path[fill=fillColor] (154.78, 38.24) rectangle (162.33,170.44);

\path[fill=fillColor] (163.17, 38.24) rectangle (170.72,189.30);

\path[fill=fillColor] (171.56, 38.24) rectangle (179.11,182.15);

\path[fill=fillColor] (179.95, 38.24) rectangle (187.50,178.90);

\path[fill=fillColor] (188.34, 38.24) rectangle (195.89,176.13);

\path[fill=fillColor] (196.73, 38.24) rectangle (204.28,177.43);

\path[fill=fillColor] (205.12, 38.24) rectangle (212.67,174.18);

\path[fill=fillColor] (213.51, 38.24) rectangle (221.06,168.49);

\path[fill=fillColor] (221.90, 38.24) rectangle (229.45,181.01);

\path[fill=fillColor] (230.29, 38.24) rectangle (237.84,168.16);
...
\path[draw=drawColor,line width= 0.3pt,line join=round] (297.85, 64.52) --
	(500.39, 64.52);

\path[draw=drawColor,line width= 0.3pt,line join=round] (297.85,117.08) --
	(500.39,117.08);

\path[draw=drawColor,line width= 0.3pt,line join=round] (297.85,169.64) --
	(500.39,169.64);
...
\path[draw=drawColor,line width= 0.6pt,line join=round] (297.85, 90.80) --
	(500.39, 90.80);

\path[draw=drawColor,line width= 0.6pt,line join=round] (297.85,143.36) --
	(500.39,143.36);

\path[draw=drawColor,line width= 0.6pt,line join=round] (297.85,195.93) --
	(500.39,195.93);
...
\path[fill=fillColor] (307.06, 38.24) rectangle (314.30, 41.60);

\path[fill=fillColor] (315.10, 38.24) rectangle (322.34, 42.41);

\path[fill=fillColor] (323.14, 38.24) rectangle (330.38, 43.52);

\path[fill=fillColor] (331.18, 38.24) rectangle (338.42, 45.03);

\path[fill=fillColor] (339.22, 38.24) rectangle (346.46, 47.10);

\path[fill=fillColor] (347.26, 38.24) rectangle (354.50, 50.86);

\path[fill=fillColor] (355.30, 38.24) rectangle (362.54, 55.58);

\path[fill=fillColor] (363.34, 38.24) rectangle (370.58, 59.95);

\path[fill=fillColor] (371.38, 38.24) rectangle (378.62, 66.78);

\path[fill=fillColor] (379.42, 38.24) rectangle (386.66, 73.41);

\path[fill=fillColor] (387.46, 38.24) rectangle (394.70, 81.81);

\path[fill=fillColor] (395.50, 38.24) rectangle (402.74, 90.39);

\path[fill=fillColor] (403.54, 38.24) rectangle (410.78, 99.84);

\path[fill=fillColor] (411.58, 38.24) rectangle (418.82,108.39);

\path[fill=fillColor] (419.62, 38.24) rectangle (426.86,118.15);

\path[fill=fillColor] (427.67, 38.24) rectangle (434.90,127.46);

\path[fill=fillColor] (435.71, 38.24) rectangle (442.94,136.55);

\path[fill=fillColor] (443.75, 38.24) rectangle (450.98,145.47);

\path[fill=fillColor] (451.79, 38.24) rectangle (459.02,154.46);

\path[fill=fillColor] (459.83, 38.24) rectangle (467.06,163.25);

\path[fill=fillColor] (467.87, 38.24) rectangle (475.10,171.67);

\path[fill=fillColor] (475.91, 38.24) rectangle (483.14,180.90);
...
\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (292.90, 87.77) {5000};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (292.90,140.33) {10000};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (292.90,192.90) {15000};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,202.36);
\definecolor{drawColor}{gray}{0.20}
...
\path[draw=drawColor,line width= 0.6pt,line join=round] (295.10, 90.80) --
	(297.85, 90.80);

\path[draw=drawColor,line width= 0.6pt,line join=round] (295.10,143.36) --
	(297.85,143.36);

\path[draw=drawColor,line width= 0.6pt,line join=round] (295.10,195.93) --
	(297.85,195.93);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,202.36);
