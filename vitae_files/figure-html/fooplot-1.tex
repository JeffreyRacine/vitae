% Created by tikzDevice version 0.12.6 on 2025-03-25 15:09:35
...
\path[fill=fillColor] ( 45.72, 38.24) rectangle ( 53.27, 45.57);

\path[fill=fillColor] ( 54.11, 38.24) rectangle ( 61.66, 51.11);

\path[fill=fillColor] ( 62.50, 38.24) rectangle ( 70.05, 56.16);

\path[fill=fillColor] ( 70.89, 38.24) rectangle ( 78.44, 60.73);

\path[fill=fillColor] ( 79.28, 38.24) rectangle ( 86.83, 69.36);

\path[fill=fillColor] ( 87.67, 38.24) rectangle ( 95.22, 95.60);

\path[fill=fillColor] ( 96.05, 38.24) rectangle (103.61,109.62);

\path[fill=fillColor] (104.44, 38.24) rectangle (112.00,109.45);

\path[fill=fillColor] (112.83, 38.24) rectangle (120.38,144.16);

\path[fill=fillColor] (121.22, 38.24) rectangle (128.77,138.62);

\path[fill=fillColor] (129.61, 38.24) rectangle (137.16,168.44);

\path[fill=fillColor] (138.00, 38.24) rectangle (145.55,172.68);

\path[fill=fillColor] (146.39, 38.24) rectangle (153.94,184.74);

\path[fill=fillColor] (154.78, 38.24) rectangle (162.33,170.89);

\path[fill=fillColor] (163.17, 38.24) rectangle (170.72,189.30);

\path[fill=fillColor] (171.56, 38.24) rectangle (179.11,181.48);

\path[fill=fillColor] (179.95, 38.24) rectangle (187.50,177.90);

\path[fill=fillColor] (188.34, 38.24) rectangle (195.89,176.75);

\path[fill=fillColor] (196.73, 38.24) rectangle (204.28,179.69);

\path[fill=fillColor] (205.12, 38.24) rectangle (212.67,174.31);

\path[fill=fillColor] (213.51, 38.24) rectangle (221.06,169.42);

\path[fill=fillColor] (221.90, 38.24) rectangle (229.45,186.86);

\path[fill=fillColor] (230.29, 38.24) rectangle (237.84, 72.46);
...
\path[draw=drawColor,line width= 0.3pt,line join=round] (297.85, 65.63) --
	(500.39, 65.63);

\path[draw=drawColor,line width= 0.3pt,line join=round] (297.85,120.40) --
	(500.39,120.40);

\path[draw=drawColor,line width= 0.3pt,line join=round] (297.85,175.17) --
	(500.39,175.17);
...
\path[draw=drawColor,line width= 0.6pt,line join=round] (297.85, 93.01) --
	(500.39, 93.01);

\path[draw=drawColor,line width= 0.6pt,line join=round] (297.85,147.78) --
	(500.39,147.78);
...
\path[fill=fillColor] (331.18, 38.24) rectangle (338.42, 45.10);

\path[fill=fillColor] (339.22, 38.24) rectangle (346.46, 47.19);

\path[fill=fillColor] (347.26, 38.24) rectangle (354.50, 51.04);

\path[fill=fillColor] (355.30, 38.24) rectangle (362.54, 55.84);

\path[fill=fillColor] (363.34, 38.24) rectangle (370.58, 60.63);

\path[fill=fillColor] (371.38, 38.24) rectangle (378.62, 67.75);

\path[fill=fillColor] (379.42, 38.24) rectangle (386.66, 74.50);

\path[fill=fillColor] (387.46, 38.24) rectangle (394.70, 83.25);

\path[fill=fillColor] (395.50, 38.24) rectangle (402.74, 92.29);

\path[fill=fillColor] (403.54, 38.24) rectangle (410.78,102.14);

\path[fill=fillColor] (411.58, 38.24) rectangle (418.82,111.05);

\path[fill=fillColor] (419.62, 38.24) rectangle (426.86,121.21);

\path[fill=fillColor] (427.67, 38.24) rectangle (434.90,130.84);

\path[fill=fillColor] (435.71, 38.24) rectangle (442.94,140.23);

\path[fill=fillColor] (443.75, 38.24) rectangle (450.98,149.54);

\path[fill=fillColor] (451.79, 38.24) rectangle (459.02,159.05);

\path[fill=fillColor] (459.83, 38.24) rectangle (467.06,168.19);

\path[fill=fillColor] (467.87, 38.24) rectangle (475.10,177.01);

\path[fill=fillColor] (475.91, 38.24) rectangle (483.14,187.00);
...
\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (292.90, 89.98) {5000};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (292.90,144.75) {10000};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,202.36);
\definecolor{drawColor}{gray}{0.20}
...
\path[draw=drawColor,line width= 0.6pt,line join=round] (295.10, 93.01) --
	(297.85, 93.01);

\path[draw=drawColor,line width= 0.6pt,line join=round] (295.10,147.78) --
	(297.85,147.78);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,202.36);
