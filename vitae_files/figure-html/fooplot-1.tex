% Created by tikzDevice version 0.12.6 on 2025-11-11 11:26:51
...
\path[draw=drawColor,line width= 0.3pt,line join=round] ( 36.11, 58.59) --
	(247.44, 58.59);

\path[draw=drawColor,line width= 0.3pt,line join=round] ( 36.11, 99.28) --
	(247.44, 99.28);

\path[draw=drawColor,line width= 0.3pt,line join=round] ( 36.11,139.98) --
	(247.44,139.98);

\path[draw=drawColor,line width= 0.3pt,line join=round] ( 36.11,180.68) --
	(247.44,180.68);
...
\path[draw=drawColor,line width= 0.6pt,line join=round] ( 36.11,119.63) --
	(247.44,119.63);

\path[draw=drawColor,line width= 0.6pt,line join=round] ( 36.11,160.33) --
	(247.44,160.33);
...
\path[fill=fillColor] ( 45.72, 38.24) rectangle ( 53.27, 45.73);

\path[fill=fillColor] ( 54.11, 38.24) rectangle ( 61.66, 50.77);

\path[fill=fillColor] ( 62.50, 38.24) rectangle ( 70.05, 55.33);

\path[fill=fillColor] ( 70.89, 38.24) rectangle ( 78.44, 61.68);

\path[fill=fillColor] ( 79.28, 38.24) rectangle ( 86.83, 70.31);

\path[fill=fillColor] ( 87.67, 38.24) rectangle ( 95.22, 96.52);

\path[fill=fillColor] ( 96.05, 38.24) rectangle (103.61,111.49);

\path[fill=fillColor] (104.44, 38.24) rectangle (112.00,105.79);

\path[fill=fillColor] (112.83, 38.24) rectangle (120.38,144.05);

\path[fill=fillColor] (121.22, 38.24) rectangle (128.77,140.96);

\path[fill=fillColor] (129.61, 38.24) rectangle (137.16,168.14);

\path[fill=fillColor] (138.00, 38.24) rectangle (145.55,171.07);

\path[fill=fillColor] (146.39, 38.24) rectangle (153.94,185.07);

\path[fill=fillColor] (154.78, 38.24) rectangle (162.33,170.26);

\path[fill=fillColor] (163.17, 38.24) rectangle (170.72,189.30);

\path[fill=fillColor] (171.56, 38.24) rectangle (179.11,181.98);

\path[fill=fillColor] (179.95, 38.24) rectangle (187.50,179.21);

\path[fill=fillColor] (188.34, 38.24) rectangle (195.89,175.47);

\path[fill=fillColor] (196.73, 38.24) rectangle (204.28,177.75);

\path[fill=fillColor] (205.12, 38.24) rectangle (212.67,174.49);

\path[fill=fillColor] (213.51, 38.24) rectangle (221.06,168.95);

\path[fill=fillColor] (221.90, 38.24) rectangle (229.45,181.98);

\path[fill=fillColor] (230.29, 38.24) rectangle (237.84,160.00);
...
\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at ( 31.16, 75.90) {250};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at ( 31.16,116.60) {500};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at ( 31.16,157.30) {750};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,202.36);
\definecolor{drawColor}{gray}{0.20}
...
\path[draw=drawColor,line width= 0.6pt,line join=round] ( 33.36,119.63) --
	( 36.11,119.63);

\path[draw=drawColor,line width= 0.6pt,line join=round] ( 33.36,160.33) --
	( 36.11,160.33);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,202.36);
...
\path[draw=drawColor,line width= 0.3pt,line join=round] (297.85, 64.62) --
	(500.39, 64.62);

\path[draw=drawColor,line width= 0.3pt,line join=round] (297.85,117.40) --
	(500.39,117.40);

\path[draw=drawColor,line width= 0.3pt,line join=round] (297.85,170.17) --
	(500.39,170.17);
...
\path[draw=drawColor,line width= 0.6pt,line join=round] (297.85, 91.01) --
	(500.39, 91.01);

\path[draw=drawColor,line width= 0.6pt,line join=round] (297.85,143.78) --
	(500.39,143.78);

\path[draw=drawColor,line width= 0.6pt,line join=round] (297.85,196.55) --
	(500.39,196.55);
...
\path[fill=fillColor] (307.06, 38.24) rectangle (314.30, 41.52);

\path[fill=fillColor] (315.10, 38.24) rectangle (322.34, 42.33);

\path[fill=fillColor] (323.14, 38.24) rectangle (330.38, 43.44);

\path[fill=fillColor] (331.18, 38.24) rectangle (338.42, 44.96);

\path[fill=fillColor] (339.22, 38.24) rectangle (346.46, 47.04);

\path[fill=fillColor] (347.26, 38.24) rectangle (354.50, 50.82);

\path[fill=fillColor] (355.30, 38.24) rectangle (362.54, 55.57);

\path[fill=fillColor] (363.34, 38.24) rectangle (370.58, 59.95);

\path[fill=fillColor] (371.38, 38.24) rectangle (378.62, 66.81);

\path[fill=fillColor] (379.42, 38.24) rectangle (386.66, 73.47);

\path[fill=fillColor] (387.46, 38.24) rectangle (394.70, 81.89);

\path[fill=fillColor] (395.50, 38.24) rectangle (402.74, 90.50);

\path[fill=fillColor] (403.54, 38.24) rectangle (410.78,100.02);

\path[fill=fillColor] (411.58, 38.24) rectangle (418.82,108.58);

\path[fill=fillColor] (419.62, 38.24) rectangle (426.86,118.38);

\path[fill=fillColor] (427.67, 38.24) rectangle (434.90,127.70);

\path[fill=fillColor] (435.71, 38.24) rectangle (442.94,136.84);

\path[fill=fillColor] (443.75, 38.24) rectangle (450.98,145.73);

\path[fill=fillColor] (451.79, 38.24) rectangle (459.02,154.78);

\path[fill=fillColor] (459.83, 38.24) rectangle (467.06,163.61);

\path[fill=fillColor] (467.87, 38.24) rectangle (475.10,172.09);

\path[fill=fillColor] (475.91, 38.24) rectangle (483.14,181.41);
...
\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (292.90, 87.98) {5000};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (292.90,140.75) {10000};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (292.90,193.52) {15000};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,202.36);
\definecolor{drawColor}{gray}{0.20}
...
\path[draw=drawColor,line width= 0.6pt,line join=round] (295.10, 91.01) --
	(297.85, 91.01);

\path[draw=drawColor,line width= 0.6pt,line join=round] (295.10,143.78) --
	(297.85,143.78);

\path[draw=drawColor,line width= 0.6pt,line join=round] (295.10,196.55) --
	(297.85,196.55);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,202.36);
